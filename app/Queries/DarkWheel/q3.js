            ...
            .then(bodies => {
                gaz_giants_info.forEach(gaz => {
                    ...
                    let possible_stars = _.filter(bodies, b => {
                        ...
                        if (b.sub_type === t_tauri_name) has_t_tauri = true;
                        return true;
                    });
                    ...
                    let biggest_star_radius = _.orderBy(possible_stars, 'radius', 'desc')[0].radius;
                ...
                toCsv(res_a, 'temperatures-sort-all-distances-large.csv');
                process.exit(0);
            });
    });
